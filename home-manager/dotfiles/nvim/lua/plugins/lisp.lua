...
local function _1_()
  ...
  return paredit.setup({keys = {[">s"] = {paredit.api.slurp_forwards, "Slurp forwards"}, ["<s"] = {paredit.api.slurp_backwards, "Slurp backwards"}, [">b"] = {paredit.api.barf_forwards, "Barf forwards"}, ["<b"] = {paredit.api.barf_backwards, "Barf backwards"}, ["<localleader>rf"] = {paredit.api.raise_form, "[R]aise [f]orm"}, ["<localleader>re"] = {paredit.api.raise_element, "[R]aise [e]lement"}, ["<localleader>wh"] = {_2_, "[W]rap element [h]ead"}, ["<localleader>wt"] = {_3_, "[W]rap element insert [t]ail"}, ["<localleader>weh"] = {_4_, "[W]rap [e]nclosing form insert [h]ead"}, ["<localleader>wet"] = {_5_, "[W]rap [e]nclosing form insert [t]ail"}, ["<("] = false, ["<)"] = false, ["<localleader>O"] = false, ["<localleader>o"] = false, [">("] = false, [">)"] = false}})
end
return {"gpanders/fennel-repl.nvim", "gpanders/nvim-parinfer", "vlime/vlime", {"andysbolton/nvim-paredit", branch = "feature/support-fennel-if-pair", config = _1_, ft = {"fennel"}}}
